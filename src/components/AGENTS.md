...
- Feature-heavy portfolio rules belong in their child doc; this file only covers parent ownership and shared shell patterns for the remaining routed screens.
...
- Do not duplicate portfolio feature rules here when a child doc already owns them.
