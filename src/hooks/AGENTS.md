...
| Portfolio stock-analysis flows | `use-stock-analysis.ts` | settings, conversations, versions, responses, preview |
...
- `use-stock-analysis.ts` is the authority for prompt-preview, conversation, version, and response hook patterns.
